print()
print("Welcome to the IPL Archives")
print("Maintained by Jasroop & Pawit Singh")
print()
print("""
...
print()
userMatch = input("Teams (Format: TEAM1vsTEAM2 or TEAM2vsTEAM1): ").strip()
matchNum = int(input("Match Number (Ex. 1, 2, 3, etc.): ")).strip().u()
print()
